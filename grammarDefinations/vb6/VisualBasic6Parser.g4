...
typeOfStmt: TYPEOF WS valueStmt (WS IS WS re_type)?;
...
asTypeClause: AS WS (NEW WS)? re_type (WS fieldLength)?;
...
re_type: (baseType | complexType) (WS? LPAREN WS? RPAREN)?;
...
//This file has been rewrote at 2021-04-14  09:14:27