...
field
  : ( REPEATED )? re_type fieldName EQ fieldNumber ( LB fieldOptions RB )? SEMI
  ;
...
oneofField
  : re_type fieldName EQ fieldNumber ( LB fieldOptions RB )? SEMI
  ;

// Map field

mapField
  : MAP LT keyType COMMA re_type GT mapName
...
//This file has been rewrote at 2021-04-13  21:20:14